...
[QuestでVR再生](#220601) | [階層構造の設定](#220602) | [バンプとノーマルマッピング](#220901) | [鏡（光沢）](#221002) | [アンビエントオクルージョン](#221003) | [ブレンドシェイプ](#221003-2) | [サブサーフェススキャッタリング](#221006) | [スキン変形のウェイト](#221006-2) | [トゥーンレンダリング](#221008) | [ガラス](#221009) | [コンストレイン](#221010) | [キーフレームアニメーション](#221010-2) | [ライト](#221010-3) | [コースティクス](#221010-4) |
***
...
* 近くに配置したスポットライト（[PointLight_Near.zip](https://github.com/mubirou/Blender-Study-Notes/blob/master/study-notes/zip/PointLight_Near.zip)）
* 遠くに配置したスポットライト（[PointLight_Infinity.zip](https://github.com/mubirou/Blender-Study-Notes/blob/master/study-notes/zip/PointLight_Infinity.zip)）
* 面光源＝エリアライト（[AreaLight.zip](https://github.com/mubirou/Blender-Study-Notes/blob/master/study-notes/zip/AreaLight.zip)）
...
参考：[Blender 3.2 新機能（シャドウコースティクス）](https://cgbox.jp/blender-3_2_0-newfanction/#index_id3)  
実行環境：Blender 3.3.0、Windows 10  
作成者：夢寐郎  
作成日：2022年10月10日  
[[TOP]](#TOP)
