...
1. 変形のテスト
    ...
    1. 不具合を確認（もっと緩やかに曲がって欲しい / 一番下のボーンと土台が一緒に曲がってしまう）  
        ![016_001_11](https://mubirou.github.io/Blender/introduction/jpg/016_001_7.jpg)
    1. 全てのボーンを選択→[ポーズ]→[トランスフォームをクリア]→[すべて]でポーズを元に戻す
1. アーマチュア＝[ポーズモード]の状態で、オブジェクト（スタンドライト）を[ウェイトペイントモード]に変更
1. マウスの右ボタンでボーンを選択→[ツール]-[ブラシ]で影響する範囲を修正  
    （注意点）  
