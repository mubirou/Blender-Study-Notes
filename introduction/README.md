...
1. [サーフェス]-[**ベースカラー**]の白いボックス部分（デフォルト値）をクリックし適当な色を選択した後、[割り当て]を押す
...
1. 引き続き、![015_004_5](https://mubirou.github.io/Blender/introduction/jpg/015_004_5.jpg)アイコンを押し→[＋]（マテリアルスロットルを追加）を選択→[新規]を押します
